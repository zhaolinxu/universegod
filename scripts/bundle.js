...
var _core = require('./scripts/game/core');

var _core2 = _interopRequireDefault(_core);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var universegod = new _core2.default();
universegod.init();

},{"./scripts/game/core":12}],10:[function(require,module,exports){
'use strict';
...
var _standardSuffixes = require('./standard-suffixes.json');
...
function format(number, decimals, unit) {
  ...
  if (number >= 1e6) {
    var index = Math.floor(logFloor(number) / 3),
        prefix = format(number / Math.pow(10, 3 * index), 3),
        unity = unit === undefined ? '' : unit;

    return '' + prefix + _standardSuffixes2.default.short[index - 2] + ' ' + unity;
...
},{"./standard-suffixes.json":11}],11:[function(require,module,exports){
module.exports={
  "short": [
...
var _semanticUiAccordion = require('semantic-ui-accordion');

var _semanticUiAccordion2 = _interopRequireDefault(_semanticUiAccordion);

var _semanticUiDropdown = require('semantic-ui-dropdown');

var _semanticUiDropdown2 = _interopRequireDefault(_semanticUiDropdown);

var _semanticUiTab = require('semantic-ui-tab');

var _semanticUiTab2 = _interopRequireDefault(_semanticUiTab);

var _favicon = require('./../util/favicon');

var _favicon2 = _interopRequireDefault(_favicon);

var _index = require('./../formatter/index');
...
var _resourceTable = require('./resourceTable');

var _resourceTable2 = _interopRequireDefault(_resourceTable);

var _generatorTable = require('./generatorTable');

var _generatorTable2 = _interopRequireDefault(_generatorTable);
...
var Game = function () {
  ...
  _createClass(Game, [{
    ...
    value: function delta() {
      ...
      var elapsed = this.now - this.before,
    ...
    key: 'render',
    value: function render(times) {
      for (var key in this.resourceTable) {
        var res = this.resourceTable[key];

        res.render();
      }

      for (var _key in this.generatorTable) {
        var gen = this.generatorTable[_key];
    ...
    value: function DOMInit() {
      (0, _jquery2.default)('.tabular.menu .item').tab();
    ...
    key: 'VARInit',
    value: function VARInit() {
      var _this = this;

      _jquery2.default.fn.transition = _semanticUiTransition2.default;
      _jquery2.default.fn.dropdown = _semanticUiDropdown2.default;
      _jquery2.default.fn.tab = _semanticUiTab2.default;
      _jquery2.default.fn.accordion = _semanticUiAccordion2.default;

      this.temperature = new _temperature2.default(this);

      this.resourceTable = (0, _resourceTable2.default)(this);
      for (var key in this.resourceTable) {
        this.resourceTable[key].init();
      }

      this.generatorTable = (0, _generatorTable2.default)(this);
      for (var _key2 in this.generatorTable) {
        this.generatorTable[_key2].init();
      }

      this.itemTable = (0, _itemTable2.default)(this);
      for (var _key3 in this.itemTable) {
        this.itemTable[_key3].init();
      }

      this.intervals.core = setInterval(function () {
        _this.delta();
    ...
    value: function init() {
      ...
      (0, _logger2.default)('welcome to Universe-God. Your goal is to make this planet habitable, good luck!', '#tab-logs');
    }
  }]);
...
},{"./../formatter/index":10,"./../util/favicon":23,"./../util/logger":24,"./generatorTable":14,"./itemTable":16,"./resourceTable":17,"./temperature":22,"jquery":2,"semantic-ui-accordion":4,"semantic-ui-dropdown":5,"semantic-ui-tab":6,"semantic-ui-transition":7}],13:[function(require,module,exports){
'use strict';
...
var Generator = function () {
  ...
  _createClass(Generator, [{
    key: 'getSuccessPlace',
    value: function getSuccessPlace() {
      var milestone = -1;
    ...
    key: 'sufficient',
    value: function sufficient() {
      var sufficient = [];

      for (var key in this.cost) {
        var res = this.game.resourceTable[key],
      ...
      return sufficient.every(function (el) {
        return el === true;
      });
    }
  }, {
    ...
    value: function infos() {
      ...
      for (var key in this.income) {
        ...
        income.push('+' + (0, _index.format)(baseIncome) + ' ' + res.name);
      }

      for (var _key in this.cost) {
        var _res = this.game.resourceTable[_key],
            price = Math.floor(this.cost[_key] * Math.pow(this.inflation, this.owned));

        cost.push('-' + (0, _index.format)(price) + ' ' + _res.name);
      }
    ...
    value: function upgrade() {
      var cost = Math.floor(this.levelCost * Math.pow(this.levelInflation, this.level + 1));
    ...
    value: function pause() {
      ...
      if (this.paused) (0, _jquery2.default)('#' + this.pauseID).removeClass('pause').addClass('play');else (0, _jquery2.default)('#' + this.pauseID).removeClass('play').addClass('pause');
    }
  }, {
    key: 'visibility',
    value: function visibility(state) {
      this.visible = state;

      state ? (0, _jquery2.default)('#' + this.buttonID).fadeIn() : (0, _jquery2.default)('#' + this.buttonID).fadeOut();
    ...
    key: 'progress',
    value: function progress(times) {
      var time = this.time / this.getTimeMult();
    ...
    value: function tooltip() {
      ...
      for (var key in this.income) {
        ...
        income.push('+' + (0, _index.format)(amount) + ' ' + res.name + ' (' + (0, _index.format)(sec) + '/s)');

        for (var item in res.cost) {
          var _amount = res.cost[item] * this.owned;

          cost.push('-' + (0, _index.format)(_amount) + ' ' + item);
        }
      }

      return {
        stats: income.join(', ') + '; ' + cost.join(', '),
        upgrade: 'Upgrade: -' + (0, _index.format)(upgrade) + ' mass, x' + this.levelEffect + ' base prod.',
    ...
    key: 'render',
    value: function render(fullRender) {
      var time = this.time / this.getTimeMult(),
          percent = this.progression / time * 100,
          tooltip = this.tooltip();

      if (time < .25) {
        (0, _jquery2.default)('#' + this.barID).width('100%');
      } else {
        (0, _jquery2.default)('#' + this.barID).width(percent + '%');
      }

      if (fullRender) {
        (0, _jquery2.default)('#' + this.statsID).html(this.text()).attr('data-tooltip', tooltip.stats);
        (0, _jquery2.default)('#' + this.upgradeID).parent().attr('data-tooltip', tooltip.upgrade);
        (0, _jquery2.default)('#' + this.successID).parent().attr('data-tooltip', tooltip.success);
      }
    }
  }, {
    key: 'init',
    value: function init() {
      ...
      (0, _jquery2.default)('#content-' + this.category).append(this.template());
      (0, _jquery2.default)('#' + this.pauseID).click(function () {
        return _this.pause();
      });
      (0, _jquery2.default)('#' + this.sellID).click(function () {
        return _this.sell();
      });
      (0, _jquery2.default)('#' + this.statsID).click(function () {
        return _this.buy();
      });
      (0, _jquery2.default)('#' + this.upgradeID).click(function () {
        return _this.upgrade();
      });

      if (!this.visible) (0, _jquery2.default)('#' + this.buttonID).hide();
...
},{"./../formatter/index":10,"jquery":2}],14:[function(require,module,exports){
'use strict';
...
module.exports = function (game) {
  ...
  // Mass generators
  generatorTable['mass-1'] = new _generator2.default({
    game: game,
    name: 'Massgen 1',
    buttonID: 'btn-mass-1',
    category: 'mass',
  ...
  generatorTable['mass-2'] = new _generator2.default({
    game: game,
    name: 'Massgen 2',
    buttonID: 'btn-mass-2',
    category: 'mass',
  ...
  generatorTable['mass-3'] = new _generator2.default({
    game: game,
    name: 'Massgen 3',
    buttonID: 'btn-mass-3',
    category: 'mass',
  ...
  generatorTable['mass-4'] = new _generator2.default({
    game: game,
    name: 'Massgen 4',
    buttonID: 'btn-mass-4',
    category: 'mass',
  ...
  generatorTable['mass-5'] = new _generator2.default({
    game: game,
    name: 'Massgen 5',
    buttonID: 'btn-mass-5',
    category: 'mass',
  ...
  // Atoms generators
  generatorTable['oxygen-1'] = new _generator2.default({
    game: game,
    name: 'Oxygener',
  ...
  generatorTable['hydrogen-1'] = new _generator2.default({
    game: game,
    name: 'Hydrogener',
  ...
  generatorTable['helium-1'] = new _generator2.default({
    game: game,
    name: 'Heliumizer',
  ...
  // Elements generators
  generatorTable['water-1'] = new _generator2.default({
    game: game,
    name: 'Watergen',
  ...
  _createClass(Item, [{
    ...
    value: function infos() {
      ...
      for (var key in this.cost) {
        ...
        cost.push('-' + (0, _index.format)(price) + ' ' + res.name);
      }
    ...
    value: function render() {
      (0, _jquery2.default)('#' + this.statsID).html(this.text());
    }
  }, {
    key: 'init',
    value: function init() {
      ...
      (0, _jquery2.default)('#content-' + this.category).append(this.template());
      (0, _jquery2.default)('#' + this.buttonID).click(function () {
        return _this.buy();
      });
...
},{"./../formatter/index":10,"jquery":2}],16:[function(require,module,exports){
'use strict';
...
module.exports = function (game) {
  ...
  itemTable['sun'] = new _item2.default({
    game: game,
    name: 'Sun',
  ...
  itemTable['atmosphere'] = new _item2.default({
    game: game,
    name: 'Atmosphere',
  ...
  itemTable['vegetation'] = new _item2.default({
    game: game,
    name: 'Vegetation',
...
module.exports = function (game) {
  ...
  resourceTable['mass'] = new _resources.Resource({
    game: game,
    name: 'mass',
    suffix: 'kg',
  ...
  resourceTable['water'] = new _resources.Resource({
    game: game,
    name: 'water',
    suffix: 'L',
    dependent: true,
  ...
  resourceTable['oxygen'] = new _resources.Resource({
    game: game,
    name: 'oxygen',
    dependent: false,
    visible: true,
  ...
  resourceTable['hydrogen'] = new _resources.Resource({
    game: game,
    name: 'hydrogen',
    dependent: false,
    visible: true,
  ...
  resourceTable['helium'] = new _resources.Resource({
    game: game,
    name: 'helium',
    dependent: false,
    visible: true,
  ...
  resourceTable['dinitrogen'] = new _resources.Resource({
    game: game,
    name: 'dinitrogen',
    dependent: false,
    visible: true,
  ...
  resourceTable['argon'] = new _resources.Resource({
    game: game,
    name: 'argon',
    dependent: false,
    visible: true,
...
},{"./resources/":18}],18:[function(require,module,exports){
'use strict';
...
var Resource = function () {
  ...
  _createClass(Resource, [{
    key: 'sufficient',
    value: function sufficient(amount) {
      var sufficient = [];
      ...
      try {
        for (var _iterator = Object.entries(this.cost)[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
          var _step$value = _slicedToArray(_step.value, 2),
              index = _step$value[0],
              value = _step$value[1];

          var res = this.game.resourceTable[index],
              cost = value * amount;
    ...
    key: 'earn',
    value: function earn(amount, income) {
      if (!this.dependent) {
        this.amount += income;
        ...
        try {
          for (var _iterator2 = Object.entries(this.cost)[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
    ...
    value: function render(times) {
      if (this.suffix) {
        (0, _jquery2.default)('#' + this.elementID).html((0, _formatter.format)(this.amount, 2, this.suffix));
      } else {
        (0, _jquery2.default)('#' + this.elementID).html((0, _formatter.format)(this.amount, 2));
      }
    }
  }, {
    key: 'init',
    value: function init() {
      (0, _jquery2.default)('#' + this.holderID).append((0, _template.template)(this));
      (0, _jquery2.default)('#' + this.containerID).attr('data-tooltip', (0, _tooltip.tooltip)(this));

      if (!this.visible) {
        (0, _jquery2.default)('#' + this.containerID).hide();
      }
    }
  }]);
...
},{"../../formatter/":10,"./template":19,"./tooltip":20,"./visibility":21,"jquery":2}],19:[function(require,module,exports){
'use strict';
...
function template(Resource) {
  var infoIcon = Resource.dependent ? '<i class="info circle icon"></i>' : '';
...
function tooltip(Resource) {
  if (Resource.dependent) {
    ...
    try {
      for (var _iterator = Object.entries(Resource.cost)[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
        var _step$value = _slicedToArray(_step.value, 2),
            index = _step$value[0],
            value = _step$value[1];
...
function visibility(Resource, state) {
  ...
  if (state) {
    (0, _jquery2.default)('#' + Resource.containerID).fadeIn('slow');
  } else {
    (0, _jquery2.default)('#' + Resource.containerID).fadeOut('slow');
  }
}
...
var Temperature = function () {
  ...
  _createClass(Temperature, [{
    key: 'handle',
    value: function handle(action, amount) {
      if (action === '-') this.value -= amount;else if (action === '+') this.value += amount;

      this.celsius = (0, _index.format)(this.value);
      this.fahrenheit = (0, _index.format)(this.convert());
    }
  }, {
    key: 'convert',
    ...
    key: 'render',
    value: function render() {
      if (typeof this.value === 'number') (0, _jquery2.default)('#display-temperature').html((0, _index.format)(this.celsius, null, '°C'));else (0, _jquery2.default)('#display-temperature').html(this.celsius);
    }
  }, {
    key: 'init',
    value: function init() {
      (0, _jquery2.default)('#overview-container').append(this.template());
    }
  }]);
...
},{"./../formatter/index":10,"jquery":2}],23:[function(require,module,exports){
'use strict';
...
module.exports = function (type, amount) {
  if (type === '-') badge -= amount;else if (type === '+') badge += amount;

  favicon.badge(badge);
};

},{"favico.js":1}],24:[function(require,module,exports){
'use strict';
...
},{"jquery":2,"moment":3,"typed.js":8}]},{},[9]);
